...
function page() {
  return (
    ...
    <img className="w-21 h-21 object:cover object:center md: ms-10 rounded-full mx-auto" src="/1.jpg" alt="" width="300" height="100"/>
    <div className="pt-6 md:p-5 text-center md:text-left space-y-4">
      <blockquote>
        <p className=" font-medium text-slate-700 dark:text-blue-1000 mx-28 pt-14">
      ...
      <figcaption className="font-medium text-sm mx-28">
